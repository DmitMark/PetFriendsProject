# python -m pytest -v --driver Chrome --driver-path C:\chromedriver.exe tests\test_auth_page.py
# python -m pytest -v --driver Firefox --driver-path C:\geckodriver.exe tests\test_auth_page.py
