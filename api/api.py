...
class PetFriendsApi:
    ...
    def get_list_of_pets(self, auth_key, filter):
        ...
        return requests.get(self.base_url+'api/pets', headers=headers, params=filter)
    ...
    def delete_pet(self, auth_key, pet_id):
        ...
        headers = {'auth_key': auth_key['key']}
        return requests.delete(self.base_url+'api/pets/'+pet_id, headers=headers)
    ...
    def update_pet_info(self, auth_key, pet_id, name, animal_type, age):
        ...
        headers = {'auth_key': auth_key['key']}
        return requests.put(self.base_url+'api/pets/'+ pet_id, headers=headers, data=data)
    ...
    def create_pet_simple(self, auth_key, name, animal_type, age):
        ...
        headers = {'auth_key': auth_key['key']}
        return requests.post(self.base_url+ 'api/create_pet_simple', headers=headers, data=data)
